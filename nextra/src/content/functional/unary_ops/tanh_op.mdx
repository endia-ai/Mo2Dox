...
[View the code on GitHub](https://github.com/endia-ai/Endia/tree/nightly/endia/functional/unary_ops/tanh_op.mojo)
...
<details>
<summary>Computes the hyperbolic tangent of the input array element-wise.</summary>
...
###### Returns
- ``Array`` - An array containing the hyperbolic tangent of each element in the input array.
...
<details>
<summary>Computes the Jacobian-vector product for the hyperbolic tangent function.</summary>
...
###### Returns
- ``Array`` - The Jacobian-vector product for the hyperbolic tangent function.
...
<details>
<summary>Computes the vector-Jacobian product for the hyperbolic tangent function.</summary>
...
<details>
<summary>Low-level function to compute the hyperbolic tangent of a complex number represented as SIMD vectors.</summary>
...
###### Returns
- ``Tuple[SIMD[float32, nelts[::DType]().__mul__(2).__floordiv__(2)], SIMD[float32, nelts[::DType]().__mul__(2).__floordiv__(2)]]`` - The real and imaginary parts of the hyperbolic tangent of the complex number as a tuple.
...
<details>
<summary>Performs the forward pass for element-wise hyperbolic tangent computation of an array.</summary>
