...
[View the code on GitHub](https://github.com/endia-ai/Endia/tree/nightly/endia/functional/unary_ops/log_op.mojo)
...
<details>
<summary>Computes the natural logarithm of the input array element-wise.</summary>
...
###### Returns
- ``Array`` - An array containing the natural logarithm of each element in the input array.
...
<details>
<summary>Computes the Jacobian-vector product for the natural logarithm function.</summary>
...
###### Returns
- ``Array`` - The Jacobian-vector product for the natural logarithm function.
...
<details>
<summary>Computes the vector-Jacobian product for the natural logarithm function.</summary>
...
<details>
<summary>Low-level function to compute the natural logarithm of a complex number represented as SIMD vectors.</summary>
...
###### Returns
- ``Tuple[SIMD[float32, nelts[::DType]().__mul__(2).__floordiv__(2)], SIMD[float32, nelts[::DType]().__mul__(2).__floordiv__(2)]]`` - The real and imaginary parts of the natural logarithm of the complex number as a tuple.
...
<details>
<summary>Performs the forward pass for element-wise natural logarithm computation of an array.</summary>
