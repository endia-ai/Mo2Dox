...
[View the code on GitHub](https://github.com/endia-ai/Endia/tree/nightly/endia/functional/unary_ops/cosh_op.mojo)
...
<details>
<summary>Computes the hyperbolic cosine of the input array element-wise.</summary>
...
<details>
<summary>Computes the Jacobian-vector product for the hyperbolic cosine function.</summary>
...
<details>
<summary>Computes the vector-Jacobian product for the hyperbolic cosine function.</summary>
...
<details>
<summary>Low-level function to compute the hyperbolic cosine of a complex number represented as SIMD vectors.</summary>
...
<details>
<summary>Performs the forward pass for element-wise hyperbolic cosine computation of an array.</summary>
