...
[Source Code](https://github.com/endia-ai/Endia/tree/main/endia/functional/unary_ops/cos_op.mojo)  
...
Computes the Jacobian-vector product for the cosine function.  
</summary>  
...
The Jacobian-vector product for the cosine function.  
Type: `Array`  
  
  


Implements forward-mode automatic differentiation for the cosine function.
...
Computes the vector-Jacobian product for the cosine function.  
</summary>  
...
Implements reverse-mode automatic differentiation for the cosine function.
...
Low-level function to compute the cosine of a complex number represented as SIMD vectors.  
</summary>  
...
The real and imaginary parts of the cosine of the complex number as a tuple.  
...
Performs the forward pass for element-wise cosine computation of an array.  
</summary>  
...
Computes the cosine of each element in the input array and stores the result in the current array.
