...
[View the code on GitHub](https://github.com/endia-ai/Endia/tree/nightly/endia/functional/binary_ops/add_op.mojo)
...
<details>
<summary>Adds two arrays element-wise.</summary>
...
###### Returns
- ``Array`` - The element-wise sum of arg0 and arg1.
...
<details>
<summary>Compute Jacobian-vector product for array addition.</summary>
...
<details>
<summary>Compute vector-Jacobian product for array addition.</summary>
...
<details>
<summary>Low-level function to add two complex numbers represented as SIMD vectors.</summary>
...
###### Returns
- ``Tuple[SIMD[float32, nelts[::DType]().__mul__(2).__floordiv__(2)], SIMD[float32, nelts[::DType]().__mul__(2).__floordiv__(2)]]`` - The real and imaginary parts of the sum of the two complex numbers as a tuple.
